...
column_01_Layout = [  
    ...
    ###jwc y [sg.Graph(GRAPH_SIZE, (0,0), GRAPH_SIZE, key='_key_Graph_', background_color='lightblue')],
    ###jwc y [sg.Graph(GRAPH_SIZE, (0,0), GRAPH_SIZE, key='_key_Graph_', background_color='lightblue'), sg.Slider((0,30), default_value=15, orientation='h', key='-DELAY2-')],
    
    ###jwc y [sg.Graph(canvas_size=GRAPH_SIZE, graph_bottom_left=(0,-graph_Vertical_MAX_INT/2), graph_top_right=(graph_Horizontal_MAX_INT,graph_Vertical_MAX_INT/2), key='_key_Graph_', background_color='lightblue'), sg.Slider((0,30), default_value=15, orientation='h', key='-DELAY2-')],
    [sg.Graph(canvas_size=GRAPH_SIZE, graph_bottom_left=(0,-graph_Vertical_Max_Now_Int), graph_top_right=(graph_Horizontal_Max_Now_Int,graph_Vertical_Max_Now_Int), key='_key_Graph_', background_color='lightblue')],
...
sub_window__key_Graph = total_window["_key_Graph_"]  # type: sg.Graph
...
###jwc n sub_window__key_Graph.DrawLine((0,0), (graph_Horizontal_Max_Now_Int,0), color='white', width=1, key='-HorizontalNowLine-')   
horizontalZeroLine_FigureObject = sub_window__key_Graph.DrawLine((0,0), (graph_Horizontal_Max_Now_Int,0), color='white', width=1)   

###jwc y verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
###jwc y verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((border_Perimeter_MARGIN_INT,-graph_Vertical_Max_Now_Int), (border_Perimeter_MARGIN_INT, graph_Vertical_Max_Now_Int), color='white', width=1)
###jwc n verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)

###jwc n verticalNowPoint_FigureObject = sub_window__key_Graph.draw_point((x_Now,0), color='red', size=5)

verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)

wrapAround_ForThisMainWhileLoop_Bool = False

# Vertical 'Now' Line
###jwc n verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1, key='-verticalZeroLine-')
###jwc n verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
###jwc n verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((10,100), (10,-100), color='white', width=1)
###jwc n2 verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
...
while True:                             # Event Loop
    ...
    total_window['-graph_Vertical_Max_Now_Int-'].update(graph_Vertical_Max_Now_Int)
    total_window['-graph_Vertical_Divider_Now_Int-'].update(graph_Vertical_Divider_Now_Int)
    ...
    total_window['-MSECPERSAMPLE-'].update(graph_Horizontal_MsecPerSample_Int)
    total_window['-PIXELPERSAMPLE-'].update(graph_Horizontal_StepSize_Int)
    ...
    ###jwc n1 verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
    ###jwc y? verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
    ...
    if x_Now >= (graph_Horizontal_Max_Now_Int-border_Perimeter_MARGIN_INT):
        ...
        ###jwc y total_window['_key_Graph_'].erase()
        ###jwc y sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject,20,0)
        ### jwc y sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject,-graph_Horizontal_Max_Now_Int+border_Perimeter_MARGIN_INT,0)
        # !!! 'relocate_figure': relative offset position
        ###jwc n sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject,-graph_Horizontal_Max_Now_Int+border_Perimeter_MARGIN_INT,0)
        # !!! Important: Absolute Positioning
        ###jwc y TYJ does work but not intuitive for here? sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject,border_Perimeter_MARGIN_INT,0)
        # !!! Important: Relative Positioning
        # !!!' relocate_figure': relative offset position
        # !!! jwc yyy for non-web (coordinates normal): sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,-(graph_Horizontal_Max_Now_Int-(border_Perimeter_MARGIN_INT*2),0))
        # !!! jwc yyy for web (coordinates reversed):
        ###jwc n sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,+(graph_Horizontal_Max_Now_Int-(border_Perimeter_MARGIN_INT*2),0))
        ###jwc n sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,(graph_Horizontal_Max_Now_Int-(border_Perimeter_MARGIN_INT*2)),0)
        ###jwc n need background_color: sub_window__key_Graph.update()
        
        ### #jwc y AAA sub_window__key_Graph.delete_figure(verticalNowLine_FigureObject) 
        ### #jwc y AAA verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)

        ###jwc AttributeError: 'SvgLine' object has no attribute 'set_position': sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject, x_Now, 0)
        
        ###jwc yy sub_window__key_Graph.delete_figure(verticalNowLine_FigureObject) 
        ###jwc yy verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
        wrapAround_ForThisMainWhileLoop_Bool = True
    ###jwc yy else:
        # !!! Important: Relative Positioning
        # !!!' relocate_figure': relative offset position
        # !!! jwc yyy for non-web (coordinates normal): sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,graph_Horizontal_StepSize_Int,0)
        # !!! jwc yyy for web (coordinates reversed):
        ###jwc y? bug workaround, go down also?: sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,-graph_Horizontal_StepSize_Int,0)
        ###jwc n sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,-graph_Horizontal_StepSize_Int,-graph_Horizontal_StepSize_Int)
        ###jwc Web: 'sub_window__key_Graph.relocate_figure(verticalNowLine_FigureObject,20,20)' 'AttributeError: 'SvgLine' object has no attribute 'set_position'',
        ###jwc web: 'sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,-graph_Horizontal_StepSize_Int,graph_Horizontal_StepSize_Int)' not reliable either.  Just redraw line.
        ###jwc n sub_window__key_Graph.move_figure(verticalNowLine_FigureObject,-graph_Horizontal_StepSize_Int,graph_Horizontal_StepSize_Int)
        ###jwc n need background_color: sub_window__key_Graph.update()

        ###jwc n sub_window__key_Graph.move_figure(verticalNowPoint_FigureObject, -graph_Horizontal_StepSize_Int, 0)  

        ###jwc y? good start: sub_window__key_Graph.draw_line((x_Now-graph_Horizontal_StepSize_Int,0), (x_Now,0), color='grey', width=1)
        ### #jwc y AAA sub_window__key_Graph.delete_figure(verticalNowLine_FigureObject) 
        ### #jwc y AAA verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)
    ...
    sub_window__key_Graph.delete_figure(verticalNowLine_FigureObject) 
    verticalNowLine_FigureObject = sub_window__key_Graph.DrawLine((x_Now,-graph_Vertical_Max_Now_Int), (x_Now, graph_Vertical_Max_Now_Int), color='white', width=1)

    ###jwc yy # Horizontal 'Zero' Line
    ###jwc yy ###jwc n sub_window__key_Graph.DrawLine((0,0), (graph_Horizontal_Max_Now_Int,0), color='white', width=1, key='-HorizontalNowLine-')   
    ###jwc yy sub_window__key_Graph.DrawLine((0,0), (graph_Horizontal_Max_Now_Int,0), color='white', width=1)   
    ...
    for rowData_ArrayList_OfDictionaryPairs_ForAllBots__Key_BotId_Int in rowData_ArrayList_OfDictionaryPairs_ForAllBots.keys():
        ...
        if rowData_ArrayList_OfDictionaryPairs_ForAllBots__Key_BotId_Int != 0:
            ...
            if rowData_ArrayList_OfDictionaryPairs_ForAllBots[rowData_ArrayList_OfDictionaryPairs_ForAllBots__Key_BotId_Int]['wrap_around_bool']:
                ...
                ###jwc 23-0527-1320 y5? sub_window__key_Graph.delete_figure(history_OfDrawLines_Queues_ManyBots_2D[rowData_ForOneBot['bot_id']]['Queue'].get())
                ...
                if(history_OfDrawLines_PerBot_AsFigureObject_AllFigureObjectsInQueue.qsize()>0):
                    sub_window__key_Graph.delete_figure(history_OfDrawLines_PerBot_AsFigureObject_AllFigureObjectsInQueue.get(history_OfDrawLines_PerBot_AsFigureObject))
                ...
                if(history_OfDrawTexts_PerBot_AsFigureObject_AllFigureObjectsInQueue.qsize()>0):
                    sub_window__key_Graph.delete_figure(history_OfDrawTexts_PerBot_AsFigureObject_AllFigureObjectsInQueue.get(history_OfDrawTexts_PerBot_AsFigureObject))
            ...
            ###jwc y total_window['_key_Graph_'].DrawLine((lastX1, rowData_ForOneBot['light_total_old']), 
            ...
            history_OfDrawLines_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawLine(
            ...
            ###jwc yy FontSize Seems to Work Only in Non-Web-Only: total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4)))
            ###jwc 23-0527-1320 y5? history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
            ...
            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
            ###
            ###jwc ym Web is limited: no font nor color: history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font='Arial 3', color='red')
            history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(
...
#
            ###jwc y total_window['_key_Graph_'].DrawLine((lastX1, rowData_ForOneBot['light_total_old']), 
            ###jwc n str total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot['light_total_old']), 
            ###jwc n total_window['_key_Graph_'].DrawLine((x_Old, int(rowData_ForOneBot['light_total_old'])), 
            
            ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot['light_total_old']), 
            ...
            ###jwc n total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now, rowData_ForOneBot_Y_Now+5), font=('Arial', 6), text_location='right')
            ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5))
            ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 10))
            ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 6))
            ###jwc n Web: TypeError: DrawText() got an unexpected keyword argument 'text_location': total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4), text_location='center')
                    
            ###jwc yy total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4)))
            ###jwc y? history_OfDrawLines_Queue_ABot_1D.put(total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4)))
            ###jwc 23-0527-1320 y5? history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
            ...
            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 3))
            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial',2), color='grey')
            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial',2), color='red')


    ###jwc y if x_Now < (GRAPH_SIZE[0]-20):               # if still drawing initial width of graph
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, lasty), (x_Now, y), width=1)
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, lasty+10), (x_Now, y+10), color='green', width=1)
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((lastX1, lastY1), (x_Now, int(rowData_ArrayList_OfDictionaryPairs_ForAllBots[0]['light_total'])), color='yellow', width=1)
    ###jwc y 
    ###jwc y     for rowData_ForOneBot in rowData_ArrayList_OfDictionaryPairs_ForAllBots:
    ###jwc y         ###jwc y total_window['_key_Graph_'].DrawLine((lastX1, rowData_ForOneBot['light_total_old']), 
    ###jwc y         ###jwc n str total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot['light_total_old']), 
    ###jwc y         ###jwc n total_window['_key_Graph_'].DrawLine((x_Old, int(rowData_ForOneBot['light_total_old'])), 
    ###jwc y         
    ###jwc y         ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot['light_total_old']), 
    ...
    ###jwc y         rowData_ForOneBot_BotLabel = str(rowData_ForOneBot['bot_id'])
    ###jwc y 
    ###jwc y         total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot_Y_Old), 
    ###jwc y                                    ###jwc y (x_Now, int(rowData_ForOneBot['light_total'])), 
    ###jwc y                                    (x_Now, rowData_ForOneBot_Y_Now), 
    ###jwc y                                    color='blue', 
    ###jwc y                                    width=1)
    ###jwc y         ###jwc n total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now, rowData_ForOneBot_Y_Now+5), font=('Arial', 6), text_location='right')
    ###jwc y         ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5))
    ###jwc y         ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 10))
    ###jwc y         ###jwc y total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 6))
    ###jwc y         total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4), text_location='center')
    ###jwc y         
    ...
    ###jwc y     ###jwc ? 'str' total_window['_key_Graph_'].Move(-graph_Horizontal_StepSize_Int, 0)
    ###jwc y     ###jwc y total_window['_key_Graph_'].Move(-1*int(graph_Horizontal_StepSize_Int), 0)
    ###jwc y     total_window['_key_Graph_'].Move(-graph_Horizontal_StepSize_Int, 0)
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, lasty), (x_Now, y), width=1)
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((x_Old, lasty+10), (x_Now, y+10), color='green', width=1)
    ###jwc y     ###jwc o total_window['_key_Graph_'].DrawLine((lastX1, lastY1), (x_Now, int(rowData_ArrayList_OfDictionaryPairs_ForAllBots[0]['light_total'])), color='yellow', width=1)
    ###jwc y 
    ###jwc y     ###jwc on for rowData_ForOneBot in rowData_ArrayList_OfDictionaryPairs_ForAllBots:
    ###jwc y     ###jwc on     ###jwc y total_window['_key_Graph_'].DrawLine((lastX1, rowData_ForOneBot['light_total_old']), 
    ###jwc y     ###jwc on     total_window['_key_Graph_'].DrawLine((x_Old, rowData_ForOneBot['light_total_old']), 
...
###jwc 23-0529-1500 yy                ###jwc 23-0527-1320 y5? sub_window__key_Graph.delete_figure(history_OfDrawLines_Queues_ManyBots_2D[rowData_ForOneBot['bot_id']]['Queue'].get())
###jwc 23-0529-1500 yy
...
###jwc 23-0529-1500 yy                sub_window__key_Graph.delete_figure(history_OfDrawLines_PerBot_AsFigureObject_AllFigureObjectsInQueue.get(history_OfDrawLines_PerBot_AsFigureObject))
###jwc 23-0529-1500 yy
...
###jwc 23-0529-1500 yy                sub_window__key_Graph.delete_figure(history_OfDrawTexts_PerBot_AsFigureObject_AllFigureObjectsInQueue.get(history_OfDrawTexts_PerBot_AsFigureObject))
...
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy            ###jwc y total_window['_key_Graph_'].DrawLine((lastX1, rowData_ForOneBot['light_total_old']), 
...
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy            history_OfDrawLines_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawLine(
...
###jwc 23-0529-1500 yy            history_OfDrawLines_PerBot_AsFigureObject_AllFigureObjectsInQueue.put(history_OfDrawLines_PerBot_AsFigureObject)
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy            ###jwc yy FontSize Seems to Work Only in Non-Web-Only: total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4)))
###jwc 23-0529-1500 yy            ###jwc 23-0527-1320 y5? history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
...
###jwc 23-0529-1500 yy            ###jwc y history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font=('Arial', 4))
###jwc 23-0529-1500 yy
###jwc 23-0529-1500 yy            ###jwc ym Web is limited: no font nor color: history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5), font='Arial 3', color='red')
###jwc 23-0529-1500 yy            history_OfDrawTexts_PerBot_AsFigureObject = total_window['_key_Graph_'].DrawText(text=rowData_ForOneBot_BotLabel, location=(x_Now-5, rowData_ForOneBot_Y_Now+5))
