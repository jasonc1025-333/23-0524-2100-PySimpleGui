...
while True:                             # Event Loop
    ...
    if x < GRAPH_SIZE[0]:               # if still drawing initial width of graph
        ...
        window['-GRAPH-'].DrawLine((lastX1, lastY1), (x, int(rowData_ArrayList_OfDictionaryPairs_ForAllBots[0]['light_total'])), color='yellow', width=1)
    ...
    lastX1, lastY1 = x, rowData_ArrayList_OfDictionaryPairs_ForAllBots[0]['light_total']
